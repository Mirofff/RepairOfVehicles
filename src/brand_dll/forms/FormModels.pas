...
type
  TForm1 = class(TForm)
    ...
    FDTableModelsname: TMemoField;
    FDTableModelscylinders: TIntegerField;
    FDTableModelsengine_displacement: TFloatField;
    FDTableModelsdrive: TMemoField;
    FDTableModelsepa_index: TIntegerField;
    FDTableModelsengine_descriptor: TMemoField;
    FDTableModelsepa_fuel_economy: TIntegerField;
    FDTableModelsfuel_type: TMemoField;
    FDTableModelstransmission: TMemoField;
    FDTableModelscity_mpg: TMemoField;
    FDTableModelshighway_mpg: TMemoField;
    FDTableModelsclass: TMemoField;
    FDTableModelsyear: TMemoField;
    FDTableModelsmfr_code: TMemoField;
    FDTableModelsbase_model: TMemoField;
